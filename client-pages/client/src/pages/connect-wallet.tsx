          ...
          {isConnecting ? (
            <Card className="w-full max-w-md p-8 flex items-center justify-center">
              <CardContent className="flex flex-col items-center">
                ...
                <p className="text-lg text-gray-400">Connecting to wallet...</p>
              </CardContent>
            </Card>
          ) : (
        ...
        <div className="w-full md:w-1/2 bg-gradient-to-br from-gray-900 to-gray-950 p-8 md:p-16 flex items-center justify-center">
          <div className="max-w-lg">
            <h1 className="text-3xl md:text-4xl font-bold mb-6 text-white">
              <span className="bg-gradient-to-r from-blue-400 to-indigo-500 text-transparent bg-clip-text">Ride | Share | Reward</span> with B3TR Tokens
            </h1>
