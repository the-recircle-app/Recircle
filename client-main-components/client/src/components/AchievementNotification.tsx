              ...
              <div className="flex-1">
                ...
                <div className="mt-3 bg-gray-800 rounded-lg p-3">
                  ...
                  <div className="space-y-1 mb-2">
                    ...
                    {/* Streak bonus - shown conditionally */}
                    {type !== 'first_store' && (
                      <div className="flex justify-between items-center text-sm reward-item">
                        ...
                        <div className="flex items-center">
                          <span className="font-medium text-white mr-1">+0.5</span>
                          <B3trLogo className="w-4 h-4" color="#38BDF8" />
                        </div>
                      </div>
                    )}
                    ...
                    <div className="flex justify-between items-center text-sm reward-item">
                      ...
                      <div className="flex items-center">
                        <span className="font-bold text-white mr-1 bg-gradient-to-r from-blue-400 to-green-400 bg-clip-text text-transparent">
                          {type === 'first_receipt' ? '18.5' : type === 'first_store' ? '8' : '8.5'}
                        </span>
                        <B3trLogo className="w-4 h-4" color="#38BDF8" />
                      </div>
                    </div>
                  ...
                  <div className="mt-3 pt-2 border-t border-gray-700">
                    ...
                    <div className="space-y-1">
                      {/* Creator sustainability fund */}
                      <div className="flex justify-between items-center text-xs reward-item">
                        <span className="text-gray-400">Creator Sustainability Fund (15%):</span>
                        <div className="flex items-center">
                          <span className="font-medium sustainability-gradient mr-1">
                            {type === 'first_receipt' ? '2.8' : type === 'first_store' ? '1.2' : '1.3'}
                          </span>
                          <B3trLogo className="w-4 h-4" color="#38BDF8" />
                        </div>
                      </div>
                      
                      {/* App sustainability fund */}
                      <div className="flex justify-between items-center text-xs reward-item">
                        <span className="text-gray-400">App Sustainability Fund (15%):</span>
                        <div className="flex items-center">
                          <span className="font-medium sustainability-gradient mr-1">
                            {type === 'first_receipt' ? '2.8' : type === 'first_store' ? '1.2' : '1.3'}
                          </span>
                    ...
                    <div className="mt-2 text-xs space-y-1">
                      ...
                      <div className="text-gray-400 pl-4">
                        <p>• 15% to Creator Fund for ecological projects</p>
                        <p>• 15% to App Fund for platform development</p>
