...
export function generateSustainabilityTags(text: string, storeName: string): string[] {
  ...
  if (lowerText.includes("game") || lowerStoreName.includes("gamestop") || lowerStoreName.includes("game stop")) {
    ...
    lowerStoreName.includes("thrift") || 
    lowerStoreName.includes("goodwill") || 
    lowerStoreName.includes("salvation army")
  ) {
    tags.push("clothing");
  ...
  // Check for thrift store keywords
  if (
    lowerStoreName.includes("thrift") || 
    lowerStoreName.includes("goodwill") || 
    lowerStoreName.includes("salvation army") || 
    lowerStoreName.includes("buffalo exchange") || 
    lowerStoreName.includes("consignment")
  ) {
    tags.push("thrift store");
  }
