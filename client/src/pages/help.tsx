...
const HelpPage: React.FC = () => {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: "You can earn B3TR tokens by scanning receipts from sustainable transportation services like rideshare, electric vehicle rentals, and public transit, referring friends to join ReCircle, and maintaining a daily streak by using the app regularly."
    },
    {
    ...
    },
    {
      ...
      answer: "After using sustainable transportation services (like Uber, Lyft, public transit, or electric vehicle rentals), navigate to the 'Scan' tab, take a clear photo of your receipt, and our system will validate it to award you B3TR tokens."
    },
    {
