 ...
 * Tests both GPT-4-Turbo and GPT-3.5-Turbo to isolate connectivity problems
 */

import 'dotenv/config';
import OpenAI from 'openai';

// Initialize OpenAI client with our enhanced settings
...
async function testTextOnlyRequest() {
  console.log("\n1. Testing basic text completion with gpt-3.5-turbo (faster model)...");
